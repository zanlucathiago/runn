...
const createOptionFromText = (questionModel) => (option) => new Option({
  text: option.text, question: questionModel,
});
...
const isOptionAvailable = (formResponses, ...params) => (option) => !formResponses.some(
